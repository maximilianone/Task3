public class TemperatureConverter {
    public double convertFtoC(double degreesFahreheit) {
        return (degreesFahreheit - 32.0) / 9.0 * 5.0;
    }
    ...
    public double convertFtoK(double degreesFahreheit) {
        return (degreesFahreheit + 459.7) / 9.0 * 5.0;
    }
